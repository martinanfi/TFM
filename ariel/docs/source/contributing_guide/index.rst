...
For now this page is work in progress. If you want to contribute, try to follow the same standards as the rest of the codebase.
We will update the guide soon with steps, AI prompt filters, and rules to follow for code quality, typing, documenting etc.
